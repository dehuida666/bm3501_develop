...
#define TONE_BTPairing			0xC0
#define TONE_BroadcastPairing	0xC1
#define TONE_Connected			0xC2
#define TONE_BatteryLow			0xC3
#define TONE_PowerOff			0xC4
